 ...
 * 或者在ribbon中禁用Eureka并且通过配置的形式指定ribbon的配置({@see service-sample/com.xy.sample.ribbon.FlRibbonClientSample})
 *  ribbon:
 *    eureka:
 *      enabled: false
 *  stores:z
 ...
 *           strategy: SEMAPHORE
 *
 *  com.fresh.xy.sample2.api.fallback,fallbackFactory属性 fallback逻辑
 *  feign:
 *    hystrix:
